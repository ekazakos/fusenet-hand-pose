...
from lasagne.layers import InputLayer, Conv2DLayer, MaxPool2DLayer, DenseLayer, dropout, ElemwiseMergeLayer, concat,LocallyConnected2DLayer, reshape, Conv1DLayer, ElemwiseSumLayer
